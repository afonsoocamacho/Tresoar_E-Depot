<nav aria-label="Main Navigation">
    ...
    <ul>
        ...
        <li><a href="/about" aria-label="Profile"><img src="{{ asset('assets/icons/user.svg') }}" alt=""></a></li>
        <li><a href="/contact" aria-label="Language toggle"><img src="{{ asset('assets/icons/globe.svg') }}" alt="">EN</a></li>
    </ul>
</nav>